...
export default function Willon() {
  ...
  return (
    <div className="relative min-h-screen w-full overflow-hidden bg-background">
      ...
      <div className="relative z-10 mx-auto flex h-screen max-w-6xl flex-col md:p-8">
        {/* Header */}
          ...
          <ScrollArea className="flex-1 p-6" ref={scrollRef}>
            {messages.length === 0 ? (
              <div className="flex h-full w-full flex-col items-center justify-center gap-8 py-4">
                ...
                <div className="relative flex h-24 w-24 items-center justify-center rounded-full border border-primary/30 bg-gradient-to-br from-primary/20 to-primary/5">
                ...
                <Textarea
                  ...
                  placeholder={
                    attachedImage
                      ...
                      : "Pergunte sobre suas finanças ou peça para cadastrar algo..."
                  }
                  className="max-h-32 min-h-[44px] resize-none rounded-xl border-border/50 bg-background/50 pr-12 text-sm focus:border-primary/50 focus:ring-primary/20"
                  rows={1}
                />
                <Button

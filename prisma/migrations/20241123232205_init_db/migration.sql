...
-- CreateEnum
CREATE TYPE "TransactionCategory" AS ENUM ('SALARIO', 'INVESTIMENTOS', 'FREELANCER', 'VENDAS', 'REEMBOLSOS', 'EMPRESTIMOS', 'ALUGUEIS', 'PREMIOS', 'DOACOES', 'OUTROS', 'ALIMENTACAO', 'TRANSPORTE', 'MORADIA', 'SAUDE', 'EDUCACAO', 'ENTRETENIMENTO', 'ROUPAS', 'VIAGENS', 'CONTAS');
